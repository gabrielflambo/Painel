...
$(document).ready(function() {
	...
	var altura = $('.head .col.center').innerHeight();
	$('.head .back img').css({
		width: '100%',
		height: altura,
		objectFit: 'cover',
	...
	var tamanho = [];
	$('.servicos .conteudo').each(function(index, el) {
		var valores = $(this).outerHeight(true);
		tamanho.push(valores);
		tamanho.sort();
		tamanho.reverse();
	});

	tamanho = parseFloat(tamanho[0]) + parseInt(20);
	$('.servicos .conteudo').css('height', tamanho);
	$('.servicos img').css('height', tamanho);

	var formulario = $('.form .col.left').innerHeight();
	$('.form .back img').css({
		width: '100%',
		height: formulario,
		objectFit: 'cover',
